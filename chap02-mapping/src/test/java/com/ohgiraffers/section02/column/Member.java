...
*   7. columnDefiniution : 직접 컬럼의 ddl을 조정
...
public class Member {
    ...
    @Transient  // 테이블 생성 시 무시된다.  자바에선 담아오지만 db에 넣지 않을 때
    ...
    @Column(name = "address", nullable = false)   // 허용 X
    private String address;

    @Column(name = "enroll_date")
    @Temporal(TemporalType.TIMESTAMP)  // DateTime  들어갈 날짜 형식 지정
